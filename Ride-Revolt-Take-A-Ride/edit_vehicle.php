                    ...
                    foreach ($results as $result) { ?>
                      ...
                      <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="selectpicker1" name="brandname" required>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input class="form-control" value="<?php echo htmlentities($result->city); ?>" name="city" required />
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="selectpicker1" name="fueltype" required>
                  ...
                  <div class="row">
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        ...
                        <?php } else { ?>
                          <div class="checkbox checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox4" name="antilockbrakingsys" value="1">
                            <label for="inlineCheckbox4"> AntiLock Braking System </label>
                          </div>
                        <?php } ?>
                      </div>
                      <div class="col-sm-3">
                        ...
                        ?>
                          <div class="checkbox checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox5" name="brakeassist" checked value="1">
                            <label for="inlineCheckbox5"> Brake Assist </label>
                          </div>
                        <?php } else { ?>
                          <div class="checkbox checkbox-inline">
                            <input type="checkbox" id="inlineCheckbox5" name="brakeassist" value="1">
                            <label for="inlineCheckbox5"> Brake Assist </label>
                          </div>
                        <?php } ?>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        ?>
                          <div class="col-sm-3">
                            <div class="checkbox checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox6" name="powersteering" checked value="1">
                              <label for="inlineCheckbox6"> Power Steering </label>
                            </div>
                          <?php } else { ?>
                            <div class="col-sm-3">
                              <div class="checkbox checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox6" name="powersteering" value="0">
                                <label for="inlineCheckbox6"> Power Steering </label>
                              </div>
                            <?php } ?>
                            </div>
                            <div class="col-sm-3">
                              ...
                              ?>
                                <div class="checkbox checkbox-inline">
                                  <input type="checkbox" id="inlineCheckbox7" name="driverairbag" checked value="1">
                                  <label for="inlineCheckbox7">Driver Airbag</label>
                                </div>
                              <?php } else { ?>
                                <div class="checkbox checkbox-inline">
                                  <input type="checkbox" id="inlineCheckbox7" name="driverairbag" value="1">
                                  <label for="inlineCheckbox7">Driver Airbag</label>
                                <?php } ?>
                                </div>
                                <div class="row">
                                  <div class="col-sm-3">
                                    ...
                                    ?>
                                      <div class="checkbox checkbox-inline">
                                        <input type="checkbox" id="inlineCheckbox8" name="passengerairbag" checked value="1">
                                        <label for="inlineCheckbox8"> Passenger Airbag </label>
                                      </div>
                                    <?php } else { ?>
                                      <div class="checkbox checkbox-inline">
                                        <input type="checkbox" id="inlineCheckbox8" name="passengerairbag" value="1">
                                        <label for="inlineCheckbox8"> Passenger Airbag </label>
                                      </div>
                                    <?php } ?>
                                  </div>
                                  <div class="row">
                                    <div class="col-sm-3">
                                      ...
                                      ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox9" name="powerwindow" checked value="1">
                                          <label for="inlineCheckbox9"> Power Windows </label>
                                        </div>
                                      <?php } else { ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox9" name="powerwindow" value="1">
                                          <label for="inlineCheckbox9"> Power Windows </label>
                                        </div>
                                      <?php } ?>
                                    </div>
                                ...
                                <div class="row">
                                  <div class="form-group">
                                    <div class="col-sm-3">
                                      ...
                                      ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox10" name="cdplayer" checked value="1">
                                          <label for="inlineCheckbox10"> CD Player </label>
                                        </div>
                                      <?php } else { ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox10" name="cdplayer" value="1">
                                          <label for="inlineCheckbox10"> CD Player </label>
                                        </div>
                                      <?php } ?>
                                    </div>
                                    <div class="col-sm-3">
                                      ...
                                      ?>
                                        <div class="checkbox  checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox11" name="centrallocking" checked value="1">
                                          <label for="inlineCheckbox11">Central Locking</label>
                                        </div>
                                      <?php } else { ?>
                                        <div class="checkbox checkbox-success checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox11" name="centrallocking" value="1">
                                          <label for="inlineCheckbox11">Central Locking</label>
                                        </div>
                                      <?php } ?>
                                    </div>
                                    <div class="col-sm-3">
                                      ...
                                      ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox12" name="crashcensor" checked value="1">
                                          <label for="inlineCheckbox12"> Crash Sensor </label>
                                        </div>
                                      <?php } else { ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox12" name="crashcensor" value="1">
                                          <label for="inlineCheckbox12"> Crash Sensor </label>
                                        </div>
                                      <?php } ?>
                                    </div>
                                    <div class="col-sm-3">
                                      ...
                                      ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox13" name="leatherseats" checked value="1">
                                          <label for="inlineCheckbox13"> Leather Seats </label>
                                        </div>
                                      <?php } else { ?>
                                        <div class="checkbox checkbox-inline">
                                          <input type="checkbox" id="inlineCheckbox13" name="leatherseats" value="1">
                                          <label for="inlineCheckbox13"> Leather Seats </label>
                                        </div>
                                      <?php } ?>
                                    </div>
